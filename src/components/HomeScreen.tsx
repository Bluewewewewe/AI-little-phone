    ...
    <div className="h-full overflow-auto">
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-4 gap-3 mb-4">
          ...
          <QuickEntry 
            icon={Users}
            label={identity?.roleA_name || '爸爸'}
            color="from-violet-500 to-purple-600"
            onClick={() => setCurrentApp('chat-dad')}
            dot
          />
          <QuickEntry 
            icon={Users}
            label={identity?.roleB_name || '妈妈'}
            color="from-pink-500 to-rose-600"
            onClick={() => setCurrentApp('chat-mom')}
            dot
          />
          <QuickEntry 
            icon={Heart}
...
function QuickEntry({ 
  ...
  return (
    <button
      onClick={onClick}
      className="flex flex-col items-center gap-2 p-3 rounded-2xl glass hover:bg-glass-hover transition-all"
    >
